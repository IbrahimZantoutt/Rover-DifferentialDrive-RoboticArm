...
#ifndef BIN_INTERFACES__SRV__DETAIL__GET_TARGETS__FUNCTIONS_H_
#define BIN_INTERFACES__SRV__DETAIL__GET_TARGETS__FUNCTIONS_H_
 ...
 * calls
 * bin_interfaces__srv__GetTargets_Request__init().
...
/**
 * It calls
 * bin_interfaces__srv__GetTargets_Request__fini()
 ...
 * bin_interfaces__srv__GetTargets_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * bin_interfaces__srv__GetTargets_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * bin_interfaces__srv__GetTargets_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_bin_interfaces
...
/**
 * It calls
 * bin_interfaces__srv__GetTargets_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_bin_interfaces
...
/**
 * It allocates the memory for the array and calls
 * bin_interfaces__srv__GetTargets_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_bin_interfaces
...
/**
 * It calls
 * bin_interfaces__srv__GetTargets_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // BIN_INTERFACES__SRV__DETAIL__GET_TARGETS__FUNCTIONS_H_
