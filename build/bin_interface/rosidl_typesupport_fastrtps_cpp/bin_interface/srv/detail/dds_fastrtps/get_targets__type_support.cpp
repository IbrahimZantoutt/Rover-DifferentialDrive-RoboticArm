...
#include "bin_interface/srv/detail/get_targets__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_bin_interface
cdr_serialize(
  const bin_interface::srv::GetTargets_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  bin_interface::srv::GetTargets_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = bin_interface::srv::GetTargets_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const bin_interface::srv::GetTargets_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<bin_interface::srv::GetTargets_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_bin_interface
const rosidl_message_type_support_t *
get_message_type_support_handle<bin_interface::srv::GetTargets_Request>()
{
  return &bin_interface::srv::typesupport_fastrtps_cpp::_GetTargets_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bin_interface, srv, GetTargets_Request)() {
  return &bin_interface::srv::typesupport_fastrtps_cpp::_GetTargets_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_bin_interface
cdr_serialize(
  const bin_interface::srv::GetTargets_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: found
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  bin_interface::srv::GetTargets_Response & ros_message)
{
  // Member: found
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = bin_interface::srv::GetTargets_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const bin_interface::srv::GetTargets_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<bin_interface::srv::GetTargets_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &bin_interface::srv::typesupport_fastrtps_cpp::_GetTargets_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bin_interface, srv, GetTargets_Response)() {
  return &bin_interface::srv::typesupport_fastrtps_cpp::_GetTargets_Response__handle;
}
...
{
  return &bin_interface::srv::typesupport_fastrtps_cpp::_GetTargets__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bin_interface, srv, GetTargets)() {
  return &bin_interface::srv::typesupport_fastrtps_cpp::_GetTargets__handle;
}
